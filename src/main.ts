      ...
      <div class="container hero__layout">
        <div class="hero__copy">
          <p class="eyebrow" data-hero-reveal>
            ...
            Free-for-personal-use planning system · Claude · Codex · Any LLM
          </p>
    ...
    <section class="toolkit section" id="toolkit" aria-labelledby="toolkit-title">
      <div class="container">
        ...
        <div class="toolkit-note" data-reveal>
          ...
          <p>Use it. Adapt it. Plan like the person who will be on-call for it. Teams and client work need a commercial licence - details in the repo.</p>
      ...
      <div class="container founder__inner">
        ...
        <aside class="founder-support" data-reveal aria-label="Optional support for the project">
          ...
          <div class="founder-support__copy">
            ...
            <a class="founder-support__more" href="./support.html">
              Read more about Simeon &amp; where support goes <span aria-hidden="true">→</span>
            </a>
          </div>
          <a
