...
> ⚠️ Team-wide use requires a commercial licence - see [LICENSE](./LICENSE) and email [hello@Veedence.co.uk](mailto:hello@Veedence.co.uk) **before** installing this way. Option A (personal install) is the free route for individuals.

Once licensed, drop it into a repository so everyone working there gets it automatically.
...
Commit the folder. Anyone who clones the repo and opens Claude Code in it gets the skill - which is exactly why this option is for licensed organizations.
